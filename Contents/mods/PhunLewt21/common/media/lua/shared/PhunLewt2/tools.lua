local json = require("PhunLewt2/json")
local tools = {}
...
--
-- Build 42.20.4 removed loadstring/load/loadfile, so mutable configuration is
-- stored as JSON rather than as executable Lua source.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- SAVE TABLE
-- Serialises a table as JSON and writes it to a file in the server Lua folder.
--
...
-- ---------------------------------------------------------------------------
-- FILE EXISTS
-- Returns true if a file exists in the server Lua folder. Used to detect
-- pre-42.20.4 .txt configuration files that need converting.
-- ---------------------------------------------------------------------------
function tools.fileExists(filename)
